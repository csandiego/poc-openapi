...
------------- | ------------- | -------------
[**callGet**](BookAPI.md#callget) | **GET** /books/{id} | 
...
BookAPI.callGet(id: id) { (response, error) in
...
let book = Book(id: 123, title: "title_example", author: "author_example") // Book | 

BookAPI.create(book: book) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
BookAPI.delete(id: id) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
BookAPI.list() { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
...
BookAPI.update(id: id, book: book) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
